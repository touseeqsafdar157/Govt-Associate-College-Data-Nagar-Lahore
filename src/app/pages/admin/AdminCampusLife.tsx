        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              {form.studentCouncil.members.map((member: any, i: number) => (
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              {form.sportsGala.highlights.map((hlt: any, i: number) => (
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
             ...
             <div className="space-y-2">
               {form.annualFunction.awards.map((awd: any, i: number) => (
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              {form.culturalEvents.map((evt: any, i: number) => (
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              {form.studentSocieties.map((soc: any, i: number) => (
                <div key={i} className="p-4 border border-gray-200 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
