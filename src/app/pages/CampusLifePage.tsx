...
export function CampusLifePage() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Sports Gala */}
      {campusLife.sportsGala && campusLife.sportsGala.highlights.length > 0 && (
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div className="space-y-3">
                    {campusLife.annualFunction.awards.map((award, i) => (
                      <div key={i} className={`flex justify-between items-center ${i !== campusLife.annualFunction.awards.length - 1 ? 'border-b pb-2' : ''}`}>
      ...
      {/* Student Societies */}
      {campusLife.studentSocieties && campusLife.studentSocieties.length > 0 && (
        <section className="py-16">
          <div className="container mx-auto px-4">
      ...
      {/* Cultural Events */}
      {campusLife.culturalEvents && campusLife.culturalEvents.length > 0 && (
        <section className="py-16 bg-[#F8F9FA]">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-[#006B3F] mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
      ...
      {/* Student Council */}
      {campusLife.studentCouncil && campusLife.studentCouncil.members.length > 0 && (
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-[#006B3F] mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>
